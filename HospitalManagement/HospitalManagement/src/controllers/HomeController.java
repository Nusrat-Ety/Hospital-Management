...
public class HomeController implements Initializable {
    ...
    private String saveData() {
        ...
        try {
            String st = "INSERT INTO patients_info ( firstname, lastname, email, gender, dob,bloodgrp,phone) VALUES (?,?,?,?,?,?,?)";
            ...
            preparedStatement.setString(6, txtbloodgrp.getText());
